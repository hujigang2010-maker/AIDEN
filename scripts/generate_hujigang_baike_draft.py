...
def build():
    ...
    add_para(
        doc,
        "说明：本稿整合政府官网、央广网、人民网、中新网、上观新闻及正规机构官网的公开报道，仅收录姓名与职务、活动可交叉印证的陈述。可直接用于百度百科创建/新增义项。灰色编辑说明部分请勿粘贴提交。",
        size=10.5,
        space_after=6,
        color=RGBColor(0x55, 0x55, 0x55),
    )
    add_heading_custom(doc, "下载地址", level=2)
    add_para(doc, "GitHub 页面（可在线预览/下载）：", size=10.5, space_after=2)
    add_para(
        doc,
        "https://github.com/hujigang2010-maker/AIDEN/blob/cursor/hujigang-baike-draft-bc0b/output/%E8%83%A1%E7%BB%A7%E5%88%9A_%E7%99%BE%E5%BA%A6%E7%99%BE%E7%A7%91%E8%AF%8D%E6%9D%A1%E8%8D%89%E7%A8%BF.docx",
        size=9.5,
        space_after=4,
        color=RGBColor(0x1A, 0x5C, 0x96),
    )
    add_para(doc, "直接下载（Raw）：", size=10.5, space_after=2)
    add_para(
        doc,
        "https://raw.githubusercontent.com/hujigang2010-maker/AIDEN/cursor/hujigang-baike-draft-bc0b/output/%E8%83%A1%E7%BB%A7%E5%88%9A_%E7%99%BE%E5%BA%A6%E7%99%BE%E7%A7%91%E8%AF%8D%E6%9D%A1%E8%8D%89%E7%A8%BF.docx",
        size=9.5,
        space_after=8,
        color=RGBColor(0x1A, 0x5C, 0x96),
    )
    ...
    add_para(
        doc,
        "胡继刚，复旦大学住房政策研究中心秘书长、上海市杨浦区科技企业联合会执行会长。曾参与不动产资产管理、新经济增长、人工智能商业化及中欧创新合作等主题的行业交流活动。〔1〕〔2〕〔3〕〔4〕〔5〕〔7〕〔8〕",
        first_line=True,
        space_after=8,
    )
    ...
    rows = [
        ("中文名", "胡继刚", "—"),
        ("主要职务", "复旦大学住房政策研究中心秘书长", "〔1〕〔2〕〔3〕〔5〕〔7〕〔8〕"),
        ("社会职务", "上海市杨浦区科技企业联合会执行会长", "〔1〕〔4〕〔7〕"),
    ]
    ...
    duties = [
        "复旦大学住房政策研究中心秘书长。〔1〕〔2〕〔3〕〔5〕〔6〕〔7〕〔8〕",
        "复旦MBA不动产资产管理协会秘书长。〔5〕",
        "上海市杨浦区科技企业联合会执行会长。〔1〕〔4〕〔7〕",
    ]
    for text in duties:
    ...
    refs = [
        {
            ...
            "insert": "概述第一句后；人物经历第五段后；两项现任社会职务后。",
        ...
        },
        {
            ...
            "insert": "概述第一句后；人物经历第四段后；执行会长职务后。",
        ...
        },
        {
            ...
            "support": "与央广网交叉印证秘书长身份及2026年人工智能峰会主办方代表公开发言；该文未同时写明执行会长职务，执行会长请以〔1〕〔4〕〔7〕为准。",
            "insert": "人物经历第五段后（与〔1〕〔7〕并用）。",
            "quote": "作为主办方代表，复旦大学住房政策研究中心秘书长胡继刚表示……",
        },
        {
            "no": "〔7〕",
            "title": "AI新质风口来了，共议超级个体成长路径",
            "source": "上观新闻（解放日报报业集团）",
            "date": "2026年5月28日",
            "url": "https://www.jfdaily.com/sgh/detail?id=1756609",
            "support": "明确记载双职务，并写明第二场圆桌论坛“由……胡继刚主持”，与央广网、中新网交叉印证2026年人工智能峰会经历；属上海主流媒体来源。",
            "insert": "概述第一句后；人物经历第五段后；两项现任职务后。",
            "quote": "第二场圆桌论坛由复旦大学住房政策研究中心秘书长、杨浦区科技企业联合会执行会长胡继刚主持，聚焦AI全产业链商业化实战拆解落地方法论。",
        },
        {
            "no": "〔8〕",
            "title": "资产管理分会成立大会暨2025不动产资产管理高质量发展论坛相关报道",
            "source": "上海市工商业联合会官网",
            "date": "2025年6月5日发布（活动日期：2025年5月28日）",
            "url": "https://www.sfic.cn/hyxq/122/26000",
            "support": "记载“复旦大学住房政策中心秘书长胡继刚”出席资产管理分会成立活动，并与相关机构代表共同登台参与复旦大学住房政策研究中心等单位的战略合作仪式。正文职务名称采用完整称谓“住房政策研究中心”，与同文后文机构全称及央媒表述一致。",
            "insert": "人物经历第三段后；研究中心秘书长职务后。",
            "quote": "……复旦大学住房政策中心秘书长胡继刚……等嘉宾也来到现场，共同见证资产管理分会成立。……资产管理分会还在会议现场与平安银行上海分行、复旦大学住房政策研究中心……等机构启动战略合作仪式……付志军、胡继刚、杜利峰、茅志杭、吴臻祺等共同登台……",
        },
    ]
    ...
    opts = [
        ...
        "新增上海市工商联官网报道：2025年5月28日出席资产管理分会成立大会并参与战略合作仪式，进一步支撑不动产资管相关公开活动。",
        "新增上观新闻（解放日报报业集团）报道：交叉印证双职务，并将2026年人工智能峰会角色由“参与圆桌”精确为“主持圆桌”。",
        "纠正2026年人工智能峰会圆桌名称：以央广网为准，写为“从算力引擎到新质资产（AI全产业链的商业化实战）”。",
        "基本信息栏仅保留中文名、主要职务、社会职务；删除职业、研究方向等易被要求补证的字段。",
        "参考资料增至8条，优先顺序：政府网站 → 央广网/人民网/中新网/上观新闻 → 工商联及机构官网。",
    ]
    ...
    verified = [
        ...
        "中新网上海〔6〕：秘书长实名 + 2026年峰会主办方代表发言。",
        "上观新闻〔7〕：双职务实名 + 明确写明主持第二场圆桌论坛。",
        "上海市工商联官网〔8〕：秘书长身份出席2025年资产管理分会成立及战略合作仪式。",
    ]
    for s in verified:
    ...
    excludes = [
        ...
        "万科、融创、金科、绿地、新城控股等完整职业履历（含LinkedIn等自述渠道；需机构官网或主流媒体实名关联后再补）。",
