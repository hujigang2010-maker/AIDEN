...
def build_ppt(output_path: Path) -> None:
    ...
    add_bullets(
        ...
        [
            ...
            "朋友说公立二甲一般能报。对方自己只是骨裂、没住院，不能当保单条款。",
            "家属会后口径正确：二甲能不能报，保险公司说了算。保险说不行就不能住。",
            "交警默认三甲，同路段有二甲先例，但不能书面保证。要留痕。",
            "不做：装病拒出院、出院再入院绕考核、代扮交警、把人社局当评残入口。",
            "手术已在齐鲁三甲完成。无论住哪，都要说清为什么转、转到哪一级。",
        ],
        size=16,
        spacing=1.22,
    )
