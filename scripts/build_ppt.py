...
add_table(s, 0.5, 1.2, 12.3, 5.6,
          ["项目", "内容"],
          [
              ("活动主题", "重构与突围 — 寻找 AI 时代的超级个体、新质资产与资本新风口"),
              ("活动时间", "2026 年 5 月 22 日 13:00 - 20:30"),
              ("活动地点", "上海·北外滩·一滴水"),
              ("主办单位", "北大经院上海校友会、复旦大学住房政策研究中心"),
              ("协办单位", "复旦大学未来信息创新学院、上海云计算创新基地、杨浦/虹口科企联、东投资联盟 等"),
...
add_table(s, 0.4, 1.1, 12.5, 5.9,
          ...
          [
              ...
              ("14:25-15:05", "圆桌一 · AI 硬核圆桌", "主持：王珏"),
              ("15:05-15:45", "巅峰对话 · 云端生态与 AI 商业化天花板", "主持：胡继刚"),
              ("15:45-16:35", "陆家嘴交响乐团 · 时光音乐会", "—"),
              ("16:35-16:55", "主旨 3 · 特殊机遇/不良资产投资的新机遇", "王维军"),
              ("16:55-17:15", "主旨 4 · 从自然利率下降到 K 型经济", "寇文红"),
              ("17:15-17:35", "主旨 5 · 从致用之学到量子智能", "张露瑶 博士"),
              ("17:35-18:15", "圆桌二 · 投资大圆桌", "主持：黄欣"),
              ("18:15-18:30", "颁奖典礼暨闭幕仪式", "—"),
              ("18:30-20:30", "VIP 高端闭门晚宴（500 人）", "冠名：绿城中国"),
          ], col_widths=[2, 7, 3.5], body_font_size=10)
...
add_table(s, 0.4, 1.1, 12.5, 5.7,
          ...
          [
              ...
              ("T02", "圆桌一 + 巅峰对话嘉宾桌", "王珏、李龙、齐宝鑫、刘文平、刘帅华、徐泳泽、黎远、刘剑英、于敬、孔华威"),
              ("T03", "圆桌二 + 理事桌", "曲承东、刘胜利、饶雪莹、马俊杰 + 张景瑞、何杭、童长征、冯旭南、葛九明、朱震"),
...
add_table(s, 0.4, 1.1, 12.5, 5.7,
          ...
          [
              ...
              ("圆桌一", "嘉宾 ×4", "白硕、李龙、齐宝鑫、刘文平", "—"),
              ("巅峰对话", "主持", "胡继刚", "杨浦科企联执行会长"),
              ("巅峰对话", "嘉宾 ×5", "刘帅华、徐泳泽、黎远、刘剑英、于敬", "—"),
              ("主旨 3", "演讲台", "王维军", "泓塬资产董事长"),
              ("主旨 4", "演讲台", "寇文红", "《跨越自然利率陷阱》作者"),
              ("主旨 5", "演讲台", "张露瑶 博士", "昆山杜克大学助理教授"),
              ("圆桌二", "主持", "黄欣", "北大经院上海校友会秘书长"),
              ("圆桌二", "嘉宾 ×4", "曲承东、刘胜利、饶雪莹、马俊杰", "—"),
              ("颁奖典礼", "颁奖嘉宾 ×4", "姚志勇、胡继刚、黄欣、绿城-代表", "—"),
          ], col_widths=[2.2, 2.5, 4.5, 3.3], body_font_size=10)
add_textbox(s, 0.4, 6.85, 12.5, 0.3, "输出总数：30 张（含 5 张备用），A4 折立式双面；蔡杰、朱铭喆（B组）5/22 12:00 前完成主席台陈列。",
...
add_table(s, 0.4, 1.1, 12.5, 5.7,
          ...
          [
              (1, "绿城中国（冠名）", "晚宴背景 KT 板", "5/22 09:00", "待补", "葛九明"),
              (2, "绿城中国（冠名）", "晚宴礼品 500 份", "5/22 14:00", "待补", "张蒙"),
              (3, "腾讯云（战略）", "易拉宝 / 礼品", "5/22 10:00", "徐泳泽", "葛九明"),
              (4, "福布斯中国（战略）", "颁奖物料", "5/22 12:00", "待补", "张蒙"),
              (5, "蔚来（特约）", "展车 / 易拉宝 / 礼品", "5/22 08:00 / 10:00", "待补", "葛九明、李正超"),
          ...
          ], col_widths=[0.6, 2.5, 3, 1.8, 3.2, 1.4], body_font_size=10)
...
add_textbox(s, 0.55, 1.62, 12.2, 0.85,
            "本届峰会得以呈现，特别感谢——晚宴冠名战略合作伙伴 绿城中国；战略合作伙伴 腾讯云、福布斯中国；特约赞助商 蔚来、泰隆银行；赞助方 茶活力、美年大健康、复金汇、古井贡酒·年份原浆。让我们再次以掌声致谢。",
            size=12, color=DARK_TEXT)

add_textbox(s, 0.4, 2.6, 12.5, 0.4, "B · 分时段定点口播", size=14, bold=True, color=NAVY)
add_table(s, 0.4, 3.05, 12.5, 3.9,
          ["时间", "环节", "口播内容（节选）", "口播人"],
          [
              ("14:25", "圆桌一前", "感谢战略合作伙伴 腾讯云 的鼎力支持。", "王珏"),
              ("15:05", "巅峰对话前", "巅峰对话由 腾讯云 联合呈现，福布斯中国共同发布评选成果。", "胡继刚"),
              ("15:45", "中场前", "中场由 茶活力 与 美年大健康 共同支持。", "主持人"),
              ("16:35", "主旨 3 前", "感谢特约赞助商 泰隆银行，深耕科技金融。", "主持人"),
              ("17:35", "投资圆桌前", "投资大圆桌由 复金汇 战略支持。", "黄欣"),
              ("18:15", "颁奖典礼", "感谢福布斯中国 联合颁布年度领军机构。", "姚志勇"),
              ("18:30", "晚宴开场", "晚宴由 绿城中国 冠名，古井贡酒 为晚宴用酒，蔚来 为出行合作伙伴。", "王珏 / 胡继刚"),
          ], col_widths=[1.5, 2.2, 7.3, 1.5], body_font_size=10)
...
add_table(s, 0.4, 1.1, 12.5, 5.8,
          ["#", "赞助方", "特写镜头", "触发节点", "输出"],
          [
              (1, "绿城中国", "晚宴背景板 LOGO 全景、冠名牌特写、致辞特写", "18:00 / 18:30 / 致辞", "横竖各 5 + 视频 30s"),
              (2, "腾讯云", "LOGO 墙、徐泳泽演讲 / 圆桌镜头 ≥6", "13:00 / 15:05 / 闭幕", "嘉宾 6 + 物料 4"),
              (3, "福布斯中国", "奖杯 / 证书、颁奖瞬间合影", "18:15 颁奖", "合影 ≥3"),
              (4, "蔚来", "展车 + 内饰 + 嘉宾驻足", "13:00 / 中场", "展车 ≥8"),
              (5, "泰隆 虹口 / 杨浦", "T05/T06 双桌全景 + 行长致辞", "18:30-19:30", "每支行各 5"),
              (6, "茶活力", "茶歇区品茶 + 体验台特写", "15:45-16:35", "≥6 + 15s 视频"),
              (7, "美年大健康", "健康检测 + 嘉宾参与", "全天展位", "≥6"),
              (8, "复金汇", "签到礼品台 + 嘉宾领取", "13:00-13:30", "≥4"),
              (9, "古井贡酒", "餐桌酒瓶 + 嘉宾举杯", "18:30 / 19:00 / 19:30", "≥8"),
              (10, "全体合作伙伴", "闭幕大合影 + LOGO 墙合影", "18:30", "1-2 张高清"),
          ], col_widths=[0.6, 2.2, 5.7, 2.5, 1.5], body_font_size=10)

# ============ 10 时间节点 ============
s = blank_slide()
add_header(s, "10 / 关键时间节点 & 待补事项")
add_table(s, 0.4, 1.1, 12.5, 4.3,
          ["时间", "事项", "责任人"],
          [
              ("5/21 12:00", "赞助商口播文案、对接人、物资清单回收", "胡继刚 / 王珏"),
              ...
              ("5/22 13:00-13:30", "嘉宾签到与入场", "A 组"),
              ("5/22 13:30 / 18:30", "峰会开幕 / 闭门晚宴开始", "—"),
          ], col_widths=[2.8, 7, 2.7], body_font_size=11)

add_rect(s, 0.4, 5.6, 12.5, 1.4, LIGHT_BLUE)
add_textbox(s, 0.6, 5.65, 12.1, 0.4, "5/21 前需各方回填的\u201c待补\u201d事项（红色 = 急）", size=13, bold=True, color=NAVY)
add_textbox(s, 0.6, 6.05, 12.1, 0.9,
            "1) 绿城中国：到场 5 席名单、物资清单、对接人；   2) 福布斯中国：颁奖物料、对接人；   3) 蔚来：展车 / 礼品、对接人；   4) 茶活力 / 美年大健康 / 古井贡酒：物资 / 对接人；   5) A / B / D / E / F 组缺号志愿者手机号（韦佳玉回收）。",
            size=11, color=RED)
