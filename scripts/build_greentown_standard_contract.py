...
def build():
    ...
    add_para(doc,
             [("2、如本次活动的赞助方式为提供赞助费的，赞助费总额为¥：", False),
              ...
              ("。", False),
              ("乙方上海市杨浦区科技企业联合会系民办非企业单位（民非组织），按简易计税方式适用 3% 增值税征收率。", True),
    ...
    add_para(doc,
             [("11、", False),
              ("【双方违约责任上限】除因故意、重大过失、保密义务（第六条）、知识产权侵权（第五条）情形外，乙方就本合同项下任何违约（含累计违约）向甲方承担的赔偿责任及违约金总额，不超过本合同含税总价款的 30%（即不超过人民币 30,900 元）；超过部分乙方不予承担。本款同样适用于甲方，甲方就其违约向乙方承担的赔偿责任及违约金总额亦不超过本合同含税总价款的 30%。", True)])
