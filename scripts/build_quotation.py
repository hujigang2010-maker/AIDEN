...
def build():
    ...
    para(doc, "报价单编号：QT-2026-GTC-潮鸣外滩-001       报价日期：2026 年 5 月 20 日       有效期：本报价单签发之日起 10 个自然日内有效",
    ...
    kv_table(doc, rows=[
        ["报价方（甲方）", "上海市杨浦区科技企业联合会"],
        ["甲方联系人 / 电话", "胡继刚 / 13262607888"],
        ["受报价方（乙方）", "绿城中国控股有限公司 / ____________________________（项目主体）"],
        ["项目品牌", "绿城·潮鸣外滩"],
        ["乙方联系人 / 电话", "笪浩 / ________________"],
    ])
    blank(doc)
    ...
    kv_table(doc, rows=[
        ["收款单位", "上海市杨浦区科技企业联合会"],
        ["开户银行", "中国农业银行股份有限公司上海营口支行"],
        ["银行账号", "03354200040012533"],
    ])
    blank(doc, 2)
