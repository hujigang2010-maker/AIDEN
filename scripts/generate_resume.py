...
def build_docx() -> Path:
    ...
    add_p(
        ...
        "2021 年起任复旦大学住房政策研究中心秘书长，研究城市更新与新质产业空间如何承接产业落地；同时以杨浦科企联执行会长对接企业、招商与国际合作。"
        "要证明的是：能找到产业、企业、资本和场景，再落到一座城市、一栋楼或一个园区。一线投资计至 2021 年。",
        size=9.5,
        color=GRAY,
        space_before=8,
        space_after=2,
    ...
    for x in [
        "中心做研究、观点与报告：城市更新、存量资产与新质产业空间；关注 AI / 未来产业如何落地城市，以及城市如何用空间、政策、资本和场景吸引企业。产业方向，不是技术研发岗。",
        "2025.05「全球新经济增长引擎峰会」：主办方代表发言，并与竺劲、汪毅、王维军圆桌（人民网上海、中新社上海点名）。",
        "2026.05「人工智能商业化落地与硬核投资破局峰会」：主办方代表并主持圆桌（央广网、杨浦区政府、上观等）。行业合作组织能力，不是付费落地项目。",
    ...
    for x in [
        "复旦中心出方法、科企联对接企业，与宝龙商办等共同发起，将国际创新合作平台导入存量商业空间。",
        "公开报道点名会长王晓明、执行会长胡继刚（杨浦区政府官网等）。科技企业出海与海外企业进来一体两面，服务地方招商。",
    ]:
        bullet(doc, x)
    ...
    for i, (title, body) in enumerate(
        [("杨浦区科技企业联合会", "执行会长 · 企业 / 招商 / 出海 / 项目"), ("复旦不动产资管协会", "创始人")]
    ):
    ...
    add_p(
        ...
        "能力：投资拓展 → 政企招商 → 产业组织 → 智库与资源配置。项目底盘：国资合作、政府代建、不良盘活、轻资产委管、产业园落地。"
        "研究方向：AI 产业如何落地城市。",
        size=9,
        color=MUTED,
        space_before=4,
