...
主线：产业招商 · 城市更新 · 智能制造。
第七版：第一页写入 2026 已签约四宗（负责 / 推动 / 辅助 / 方案拟定）。
...
def build_docx() -> Path:
    ...
    for i, (k, v) in enumerate(
        [("一线投拓", "10 年"), ("2026 已签约", "四宗产业合作"), ("靖江 + 金坛", "43 亿"), ("现职", "复旦中心秘书长")]
    ):
    ...
    add_p(
        doc,
        "万科上海区域投资副总经理。2011–2021 一线投拓，做成国资合作、政府代建、不良盘活、轻资产委管与物流园，证明能把结构做成。"
        "2021 年起任复旦大学住房政策研究中心秘书长。2026 年已签约产业合作按负责 / 推动 / 辅助 / 方案拟定落笔：写委托与协同，不写入驻名单。"
        "一线投资计至 2021 年。",
        size=9.5,
        color=GRAY,
        space_before=8,
    ...
    for x in [
        ...
        "2026.03 北欧创新国际会客厅共同发起，落户杨浦宝龙旭辉广场环创中心。宝龙商办不是雇主。",
        "2025.05 全球新经济增长引擎峰会主办方代表发言，与竺劲、汪毅、王维军圆桌（人民网上海、中新社上海点名）。",
    ]:
        bullet(doc, x)
...
**闸门：有甲方盖章原件，国资更新和产业导入岗可以开始投；没有文件，先别对外发第七版简历。**
