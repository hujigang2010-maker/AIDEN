...
def build_internal():
    ...
    add_para(
        doc,
        "举例：你付 15 万授权费，场地再投入 5 万，宣传、制作、人员再投入 5 万，活动开始前就已经承担约 25 万风险。假设平均客单价 699 元，仅覆盖这 25 万直接投入，就需要约 358 个付费用户，还没算税费、平台佣金、赠票、退款。没有非常强的售票把握，这笔账不成立。",
        first_line=True,
    )
    add_table(
        doc,
        ...
        [
            ...
            ["客单价假设", "699 元", "仅用于测算，不是定价建议"],
            ["覆盖 25 万所需付费人数", "约 358 人", "尚未计算税、佣金、赠票、退款"],
        ],
        [5.4, 4.4, 6.6],
        header_fill=RED_HEX,
    )
    ...
    add_table(
        ...
        [
            ...
            ["数字", "记熟：书面 60%、口头 70%、底线 50%；赞助 70%；买断测算 25 万 / 358 人。"],
