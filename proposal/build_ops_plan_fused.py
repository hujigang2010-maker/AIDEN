...
EVENTS = [
    ...
    dict(code="E2", cat="E", name="AI Builders Night·建造者之夜", month="2026年8月中旬", format="夜场社交", people="120人", dm="≤30%",
    ...
    dict(code="F2", cat="F", name="国别会客厅·AI合作领事专题", month="2026年11月下旬", format="领事沙龙", people="40人", dm="90%",
         ...
         deliver="同上"),
    dict(code="A5", cat="A", name="具身智能空间交互体验日", month="2026年12月上旬", format="体验日", people="60人", dm="≤30%",
