...
nxt(); s = slide(); header(s, "05", "EVENT VALUE", "活动价值论证 · 30 场/30 万怎么做与效果"); footer(s, IDX)
card(s, ML, Inches(1.75), Inches(3.78), Inches(3.05), "怎么做（形式）", accent=ACC, items=[
    "AI 培训 / 黑客松、政策沙龙 / 路演",
    "行业对接 / 撮合 / 游学",
    "IP 潮玩市集、漫展 / 大型活动",
    "领事专题 / 买家团 / 出海推介",
    "线上投流引流 → 线下办会 → 转化"])
card(s, Inches(4.79), Inches(1.75), Inches(3.78), Inches(3.05), "带来什么效果（可衡量）", accent=GOLD, items=[
    "每场 ≥30 人，年触达 900+ 精准客户",
    "110:1 招商漏斗，转化租客/企业",
    "完成载体 KPI → 补贴 10–20 万/年",
    "媒体曝光 ≥150 万，提升项目声量",
    "为出海/撮合/会籍持续输送客源"])
card(s, Inches(8.78), Inches(1.75), Inches(3.7), Inches(3.05), "是否带来收入", accent=GREEN, items=[
    "漫展：门票 + 赞助（经营性收入）",
    "培训 / 训练营：按人/按场收费",
    "赞助商 / 展位 / 冠名",
    "活动转化企业服务与撮合收入",
...
bullets(s, Inches(1.1), Inches(5.55), Inches(5.6), Inches(0.9),
        ["价值：去化提速 + 补贴达标 + 品牌声量 + 企业转化（对标魔术空间约 110 场/年）",
         "30 场为满足招商/载体/补贴各项要求的基线，可按招人方式动态调整"], size=11, gap=4, mark=GOLD)
bullets(s, Inches(6.9), Inches(5.55), Inches(5.5), Inches(0.9),
        ["30 万为固定活动执行费（策划/执行/导师/物料）",
         "门票/赞助/培训等经营性收入单独结算，可冲抵成本"], size=11, gap=4, mark=GOLD)
