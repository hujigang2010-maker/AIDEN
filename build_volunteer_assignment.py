...
ASSIGNMENT = [
    ...
    ("C", "动线引导+前两排带位（调入）","LV",          "B → C",     "—",
     "★5/16 从 B 调入 C：负责前 4 排席卡带位+圆桌嘉宾按席卡入座引导"),
...
MILESTONES = [
    ...
    ("T-3 (5/19)",  "★ 晚宴抽奖奖品确认（一/二/三等奖）",             "韦佳玉+赞助"),
    ("T-3 (5/19)",  "★ 节目供应商提案确认（陈潇推荐）",                "陈潇+韦佳玉"),
    ("T-3 (5/19)",  "★ 前两排观众+发奖人提前通知文档化",               "C 徐胜博"),
    ...
    ("T-1 (5/21) 下午", "★ 现场踏勘 2 + 吴伟灯光位置确认 + 讲台尺寸量取","A+C+E+F+佳玉"),
...
MATERIALS = [
    ...
    ("会务", "★ 志愿者专用橙色胸牌",          "27 张（含韦佳玉）",     "F",   "T-2 完成（张蒙建议）"),
    ...
    ("技术", "★ 对讲机（5/16 修正 26→10 台）","10 台（每组组长 1 台+C/E/G 多 1 台+机动）","A+E",
     "T-0 当天租赁"),
    ...
    ("通知", "★ 前两排观众+发奖人提前通知",   "★ 5/16 陈潇方案",       "C 徐胜博","T-1 文档化发到群"),
]
