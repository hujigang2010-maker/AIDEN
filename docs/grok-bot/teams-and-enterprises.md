...
| Plan | Access |
| --- | --- |
| Individuals | Available with SuperGrok Heavy, Cursor Ultra, or a one-time trial. |
| Self-serve teams | Available. Premium seats include a weekly Grok Bot usage allowance. Standard seats can use the free trial or on-demand usage. |
