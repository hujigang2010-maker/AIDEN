...
我想用 30 分钟的时间，把我自己在一线对这个题目的观察和实践，做一个汇报，请各位老师批评指正。""",
    ...
    2: """【过场页 · 不展开】
这一页是摘要，前面已经书面提交过，今天就不再宣读。
直接进入大纲。""",

    3: """【宣读大纲 · 约 1 分钟】
今天的汇报，一共分四个板块：
第一，时代定调，我用 5 分钟，谈"十五五"开局与房地产周期的新旧转换；
第二，破局寻路，用 8 分钟，谈房地产新模式的核心内涵；
第三，核心动能，用 12 分钟，也是今天的重点，谈科技创新如何驱动不动产高质量发展；
最后第四部分，用 5 分钟，做一个总结展望。
...
首先，进入第一板块——时代定调。""",
    ...
    5: """【约 90 秒 · 宏观背景】
要谈房地产，首先要把它放回国家大盘里看。
"十五五"是一个非常特殊的五年：它不是简单的"十四五"的延续，而是国家由中高速增长正式转向高质量发展的关键期，也是构建新发展格局、培育新质生产力的攻坚期。
...
我想强调一句：这个转变不是周期性回调，而是结构性、范式性的"换轨"。""",
    ...
    7: """【约 1 分钟 · 核心论点 · 一定要让老师们记住这句话】
基于以上判断，我提出今天汇报的核心论点：
"十五五"期间的房地产高质量发展，不再是单纯的去化和土储竞争，而是"存量资产精细化运营"与"科技产业化融合"的竞争。
具体可以拆成三个根本转移：
第一，从开发转向运营——以前拼建造速度，现在拼服务体验和长期收益；
第二，从资产转向平台——重资产持有让位于轻资产管理输出；
第三，从空间转向生态——单纯提供物理空间已经不够了，要构建产业+科创+资本的生态。
这三个转移，是我后面所有内容的逻辑起点。""",
...
1.0 阶段，是解决"有没有"的居住空间——刚需和改善；
2.0 阶段，是解决"好不好"的办公空间——商办、商业、物流；
3.0 阶段，是产城融合，解决"活不活"——科创园、总部基地开始出现；
而"十五五"我们要建设的，是 4.0 阶段——科创生态，解决的是"能不能孕育新质生产力"这个根本问题。
这一阶段的不动产，已经不只是容器，而是让"科技、资本、人才"三方共振的产业舞台，我们行内有句话叫"超级会客厅"。
我想这是判断一个项目高不高质的最重要标尺。""",

    10: """【约 4 分钟 · 新模式两大特征】
具体来说，"新模式"有两大底层特征：
一个是"轻重分离"——重资产持有逐步转向轻资产管理输出和品牌输出。
资本结构上，降低对单一开发利润和高杠杆融资的依赖；
能力上，把管理、运营、招商、科技四种能力打包对外赋能；
收益上，做管理费 + 业绩分成 + 长期租金 + 资管增值的复合结构；
退出上，对接公募 REITs、类 REITs、不动产私募基金。
另一个是"产城融合"——把不动产真正嵌入实体经济，
打造科创"超级会客厅"，对接高校智库、科技企业和国际创新资源；
围绕"专精特新"企业，包括新冒出来的 OPC 单一人公司这类新主体，做定制化的场景运营；
让不动产成为产业升级和城市更新的"连接器"，承担孕育新质生产力的物理底座。
一手做减法（轻），一手做加法（产）——这就是新模式的两条腿。""",

    11: """【PART 03 章节切换 · 10 秒】
下面进入今天的重点——第三部分，核心动能：科技创新如何驱动不动产高质量发展。
这一段我用 12 分钟，主要结合我自己实战中看到的场景来谈。""",

    12: """【约 1.5 分钟 · 三条主线总览】
我把科技驱动不动产的路径，归纳为三条主线：
...
我下面逐条展开。""",
    ...
    13: """【约 3.5 分钟 · 管理提效 · 第三部分主阵地之一】
先说第一条——管理提效，重点是大语言模型加 AI 在不动产经营的落地。
四个最直接的场景：
...
关键词其实就四个——自动化、数据资产化、人机协同、端到端流程再造。""",
    ...
    14: """【约 3.5 分钟 · 空间增值 · 第三部分主阵地之二】
第二条主线是空间增值——靠科创生态让物业的价值二次跃升。
左边是我们做项目的"生态四层结构"：
最底层是空间层——高品质物业、共享场景、数字基础设施；
往上是创新层——前沿科技沙龙、国际创新路演、高校智库；
再往上是产业层——专精特新企业、总部基地、OPC 单一人公司；
最上面是资本层——国资基金、产业基金、不动产 REITs。
四层叠在一起，物业就从砖头变成了"生态位"。
右边是几个我自己在做的典型场景：前沿科技沙龙、国际创新路演、专精特新加速器、OPC 共享总部——
这些场景的本质，是把"出租平方米"升级为"出租生态位"。
这是高质量发展在物业层面最直接的体现。""",

    15: """【约 3 分钟 · 跨界协同 · 第三部分主阵地之三】
...
三圈协同的红利，体现在三个闭环：
理论到落地——高校研究在园区做中试和产业化；
产业到资本——好项目通过 REITs 和私募实现价值变现；
资本到学术——投资反哺研究和人才培养，再形成新一轮闭环。
这种协同，会带来不动产价值的"二次跃升"——从空间溢价升级为生态溢价。""",

    16: """【PART 04 章节切换 · 10 秒】
接下来是最后一部分——总结展望。""",

    17: """【约 2 分钟 · 发展共识】
"十五五"的高质量发展，绝不是哪一方单打独斗能做到的，
它是学术界和实业界的双轮驱动：
学术界负责提供方向——理论指引、方法供给、人才培育；
实业界负责蹚出新路——工具创新、场景试验、生态构建。
没有学术界的"望远镜"，行业容易短视；
没有实业界的"显微镜"，理论也容易悬空。
...
def attach_notes():
    for idx, slide in enumerate(prs.slides, start=1):
        if idx in SPEAKER_NOTES:
            set_notes(slide, SPEAKER_NOTES[idx])
