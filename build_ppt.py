...
# ============================================================
s = add_slide()
header(s, "02  合作主体", "三方角色与定位", "02 / 08")
cards = [
...
# ============================================================
s = add_slide()
header(s, "04  准入与申请", "准入门槛与申请条件", "04 / 08")
# 左：高端办公门槛
...
# ============================================================
s = add_slide()
header(s, "05  补贴方式", "补贴与优惠方式 · 三大支柱", "05 / 08")
pillars = [
    ("租金减免", "免几个月 · 补几个月", BLUE,
...
# ============================================================
s = add_slide()
header(s, "06  补贴标准", "补贴标准一览（按企业规模分档）", "06 / 08")
rows = [
    ["企业规模（人）", "算力补贴额度\n(元/年)", "免费消费券", "租金减免\n方案", "云/运营\n消费补贴", "大额签约\n折扣"],
...
# ============================================================
s = add_slide()
header(s, "07  共赢价值", "三方共赢与协同价值", "07 / 08")
vals = [
...
# ============================================================
s = add_slide()
header(s, "08  落地路径", "落地路径与下一步", "08 / 08")
phases = [
